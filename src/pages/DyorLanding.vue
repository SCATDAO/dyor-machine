<template>
  <div class="css-landing-cws">
    <div class="css-landing-cwx">
      ...
      <span class="css-landing-xww">Scan with camera</span>
      ...
      <span class="css-landing-xww">Or upload QR code</span>
      ...
      <div class="css-landing-cqs">Result: {{ reactiveResponse }}</div>
