                ...
                <div class="css-work-finished-stw">
                  ...
                  <div class="css-work-finished-sfw">
                    ...
                    <div class="css-work-finished-std">
                      ...
                      <div class="css-work-finished-stx">{{ totalScore }}%</div>
                    ...
                    <div class="css-work-finished-sha">
                      ...
                      <template v-if="isSharing">
                        <div class="css-work-finished-sox">
                          ...
                          <a
                            target="_blank"
                            :href="`http://www.reddit.com/submit?url=Click%20here%20to%20view%20my%20DYOR%20Tool%20Report%20%20-%20https://audits.dyortool.io/report/${id}`"
                          >
                            <svg
                              viewBox="0 0 800 800"
